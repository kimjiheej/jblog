    ...
    <ul>
        ...
        <div id="wrapper">
            <div id="content" class="full-screen">
             ...
             <td>
    <a href="${pageContext.request.contextPath}/${user.id}/admin/category/delete/${category.no}">
        <img src="${pageContext.request.contextPath}/assets/images/delete.jpg" alt="삭제">
                ...
                <form action="${pageContext.request.contextPath}/${user.id }/admin/category/register" method="post">
